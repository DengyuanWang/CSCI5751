...
def get_num_rides(start_year, start_month, end_year, end_month):
    ...
    if start_year>end_year or (start_year==end_year and start_month>end_month) or start_year<2010 or end_year>2020 or start_month<0 or start_month>12:
        ...
        for year in range(start_year, end_year+1):
            ...
            if year==start_year:
                end_month_this_year = (12, end_month)[start_year==end_year]
                first_key_name = (str(year)+"_0"+str(start_month)+"_MIN_MAX"+"RecordsCounts",str(year)+"_"+str(start_month)+"_MIN_MAX"+"RecordsCounts")[start_month>=10]
                last_key_name = (str(year)+"_0"+str(end_month_this_year)+"_MIN_MAX"+"RecordsCounts",str(year)+"_"+str(end_month_this_year)+"_MIN_MAX"+"RecordsCounts")[end_month_this_year>=10]
                ...
                last_key_name = (str(year)+"_0"+str(end_month)+"_MIN_MAX"+"RecordsCounts",str(year)+"_"+str(end_month)+"_MIN_MAX"+"RecordsCounts")[end_month>=10]
                last_response = table.get_item(
                    Key={
                        'Key': last_key_name
                    }
...
if __name__=="__main__":
    ...
    print('the max duration between %d-%d to %d-%d is %d'%(start_year,start_month,end_year,end_month,get_max_dur(start_year,start_month,end_year,end_month)))
    print('the min duration between %d-%d to %d-%d is %d'%(start_year,start_month,end_year,end_month,get_min_dur(start_year,start_month,end_year,end_month)))
    print('the num of rides between %d-%d to %d-%d is %d'%(start_year,start_month,end_year,end_month,get_num_rides(start_year,start_month,end_year,end_month)))
    print('the num of rides between %d-%d to %d-%d is %d'%(start_year,start_month,end_year,end_month,get_num_casual(start_year,start_month,end_year,end_month)))
    print('the num of rides between %d-%d to %d-%d is %d'%(start_year,start_month,end_year,end_month,get_num_membership(start_year,start_month,end_year,end_month)))
