...
if __name__=="__main__":
    ...
    print(get_max_dur(start_year,start_month,end_year,end_month))
    print(get_min_dur(start_year,start_month,end_year,end_month))
    print(get_num_rides(start_year,start_month,end_year,end_month))
    print(get_num_casual(start_year,start_month,end_year,end_month))
    print(get_num_membership(start_year,start_month,end_year,end_month))
